...
public class ElkReasoner implements OWLReasoner {
	...
	protected final boolean isAllowFreshEntities;
	protected final ReasonerStageExecutor stageExecutor_;
	...
	protected ElkReasoner(OWLOntology ontology, boolean isBufferingMode,
			ElkReasonerConfiguration elkConfig) {
